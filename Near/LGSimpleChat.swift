...
class LGChatMessageCell : UITableViewCell {
    ...
    struct Appearance {
        ...
        static var userColor = UIColor.clearColor()//UIColor(red: 0.14726, green: 0.838161, blue: 0.533935, alpha: 1)//my custom code
        static var font: UIFont = UIFont.systemFontOfSize(17.0)//my custom code
    }
    ...
    */
    ...
    private func styleTextViewForSentBy(sentBy: LGChatMessage.SentBy) {
        ...
        case .Opponent:
            ...
            self.textView.backgroundColor = UIColor(red: 241/255, green: 241/255, blue: 241/255, alpha: 1.0)//my custom code
            self.textView.textColor = UIColor.grayColor()//my custom code
        ...
        case .User:
            ...
            self.textView.backgroundColor = UIColor(red:  0/255, green: 132/255, blue: 255/255, alpha: 1.0)//my custom code
            self.textView.textColor = UIColor.whiteColor() //my custom code
        }
    }
}
